CREATE TABLE IF NOT EXISTS users (
    ...
    CONSTRAINT chk_users_interested_in CHECK (interested_in IS NULL OR interested_in IN ('male', 'female'))
);
...
WHERE profile_photo_file_id IS NULL
   ...
   OR (gender IS NOT NULL AND gender NOT IN ('male', 'female'))
   OR (interested_in IS NOT NULL AND interested_in NOT IN ('male', 'female'));
